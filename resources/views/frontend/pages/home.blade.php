...
@section('content')
    ...
    <div class="container mt-5 mb-5">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 mt-5 mt-lg-0">
                <div class="row">
                    <div class="col text-center"><img src="{{ asset('images/front/heads-or-tails.png') }}" class="img-fluid w-50"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5 mb-5">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 mt-5 mt-lg-0">
                <div class="row">
                    <div class="col text-center"><img src="{{ asset('images/front/dice-3d.png') }}" class="img-fluid w-75"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5 mb-5">
        <div class="row align-items-center">
            <div class="col-lg-6 order-2 mt-5 order-lg-0 mt-lg-0">
                <div class="row">
                    <div class="col text-center"><img src="{{ asset('images/front/baccarat.png') }}" class="img-fluid w-75"></div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="bg-secondary p-4">
    ...
    <div class="container mt-5 mb-5">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 mt-5 mt-lg-0">
                <div class="row">
                    <div class="col text-center"><img src="{{ asset('images/front/lucky-wheel.png') }}" class="img-fluid"></div>
                </div>
            </div>
        </div>
    </div>
